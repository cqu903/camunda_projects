...
@Service
@ExternalTaskSubscription(topicName = "try_self_repair", processDefinitionKey = "Process_external_task", lockDuration = 10000)
@Slf4j
public class SelfRepairService implements ExternalTaskHandler {
